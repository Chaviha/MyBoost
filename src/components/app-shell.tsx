...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { to: "/businesses", label: "Dashboard", icon: LayoutDashboard, perm: "manage_own_businesses" },
      { to: "/businesses", label: "Businesses", icon: Building2, perm: "manage_own_businesses" },
      ...
      { to: "/services", label: "Services", icon: BriefcaseBusiness, perm: "view_products" },
      { to: "/categories", label: "Categories", icon: Tags, perm: "view_products" },
      { to: "/specifications", label: "Specifications", icon: ListTree, perm: "view_products" },
      { to: "/variants", label: "Variants", icon: Layers, perm: "view_products" },
      { to: "/inventory", label: "Inventory", icon: Package, perm: "view_products" },
      ...
      { to: "/requests", label: "Requests", icon: Send, perm: "approve_requests" },
